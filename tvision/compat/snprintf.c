...
--------------080402090601050901070509
Content-Type: message/rfc822;
 name="CVS: tvision/examples/bhelp thelp.cc,1.1.2.1,1.1.2.2"
Content-Transfer-Encoding: 7bit
Content-Disposition: inline;
 filename="CVS: tvision/examples/bhelp thelp.cc,1.1.2.1,1.1.2.2"

Return-path: <tvision-checkins-admin@lists.sourceforge.net>
Envelope-to: salvador@inti.gov.ar
Delivery-date: Wed, 16 Apr 2003 16:56:38 -0300
Received: from nav.inti.gov.ar ([200.10.161.45])
	by violeta.inti.gov.ar with smtp (Exim 4.12)
	id 195t1K-0005lE-00
	for salvador@inti.gov.ar; Wed, 16 Apr 2003 16:56:38 -0300
Received: from samantha.inti.gov.ar ([200.10.161.31])
 by nav.inti.gov.ar (NAVGW 2.5.1.16) with SMTP id M2003041616563900378
 for <salvador@inti.gov.ar>; Wed, 16 Apr 2003 16:56:39 -0300
Received: from lists.sourceforge.net ([66.35.250.206] helo=sc8-sf-list1.sourceforge.net)
	by samantha.inti.gov.ar with esmtp (Exim 3.02 #1)
	id 195t1J-0006wV-00
	for salvador@inti.gov.ar; Wed, 16 Apr 2003 16:56:37 -0300
Received: from sc8-sf-list2-b.sourceforge.net ([10.3.1.14] helo=sc8-sf-list2.sourceforge.net)
	by sc8-sf-list1.sourceforge.net with esmtp 
	(Cipher TLSv1:DES-CBC3-SHA:168) (Exim 3.31-VA-mm2 #1 (Debian))
	id 195t0n-0004oO-00
	for <set@users.sourceforge.net>; Wed, 16 Apr 2003 12:56:05 -0700
Received: from sc8-sf-list1-b.sourceforge.net ([10.3.1.13] helo=sc8-sf-list1.sourceforge.net)
	...
	id 195t12-000180-00
	for <set@users.sourceforge.net>; Wed, 16 Apr 2003 12:56:20 -0700
Received: from sc8-sf-sshgate.sourceforge.net ([66.35.250.220] helo=sc8-sf-netmisc.sourceforge.net)
	by sc8-sf-list1.sourceforge.net with esmtp 
	(Cipher TLSv1:DES-CBC3-SHA:168) (Exim 3.31-VA-mm2 #1 (Debian))
	id 195t08-0004iW-00
	for <tvision-checkins@lists.sourceforge.net>; Wed, 16 Apr 2003 12:55:24 -0700
Received: from sc8-pr-cvs1-b.sourceforge.net ([10.5.1.7] helo=sc8-pr-cvs1.sourceforge.net)
	...
	id 195t07-0006ci-00
	for <tvision-checkins@lists.sourceforge.net>; Wed, 16 Apr 2003 12:55:23 -0700
Received: from set by sc8-pr-cvs1.sourceforge.net with local (Exim 3.22 #1 (Debian))
	id 195t07-0000S2-00
	for <tvision-checkins@lists.sourceforge.net>; Wed, 16 Apr 2003 12:55:23 -0700
To: tvision-checkins@lists.sourceforge.net
Subject: CVS: tvision/examples/bhelp thelp.cc,1.1.2.1,1.1.2.2
Message-Id: <E195t07-0000S2-00@sc8-pr-cvs1.sourceforge.net>
...
Date: Wed, 16 Apr 2003 12:55:23 -0700

Update of /cvsroot/tvision/tvision/examples/bhelp
In directory sc8-pr-cvs1:/tmp/cvs-serv840/examples/bhelp
