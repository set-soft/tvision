...
RHIDE_COMPILE_C=$(RHIDE_GCC) -zq -fo=$(OUTFILE)$(CFLAGS) $(INCLUDE_DIRS)  \
	$(SOURCE_NAME)
RHIDE_COMPILE_CC=$(RHIDE_GXX) -zq -fo=$(OUTFILE)$(CFLAGS) $(INCLUDE_DIRS)  \
	$(SOURCE_NAME)
RHIDE_COMPILE_ARCHIVE=$(RHIDE_AR) $(RHIDE_ARFLAGS) name $(OUTFILE) \
	file { $(ALL_PREREQ) kernel32.lib user32.lib gdi32.lib }
