...
/* MSVC will be supported if volunteers tests it or Microsoft decides to
 ...
 /*
   ...
   Until somebody can tell me what's wrong here. The pointer is 32 bits and the uipointer
   is also 32 bits. Both are unsigned. So I can't see where is the "pointer truncation".
   This is generated by 7.10.
 */
 #if _MSC_VER >= 1310
