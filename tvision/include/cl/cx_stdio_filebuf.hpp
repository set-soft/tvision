// This is supposed to help when using CLang and MacOSX
// If you can confirm it please contact me so I can add it cleanly.
// If this is CLang specific we should detect CLang and enable it.
